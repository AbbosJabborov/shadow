...
import { f as isElement, t as useStableCallback, u as getWindow } from "./useStableCallback-DF84v7IZ.js";
import { t as useIsoLayoutEffect } from "./useIsoLayoutEffect-XBfELL_r.js";
import { i as NOOP, r as EMPTY_OBJECT, t as useRenderElement } from "./useRenderElement-4d487dsh.js";
import { r as mergeProps } from "./merge-props-B1zstas5.js";
import { _ as triggerHover, i as createChangeEventDetails, n as contains, p as none, r as getTarget, s as disabled, u as imperativeAction, v as triggerPress } from "./shadowDom-BSobRg9T.js";
import { C as fastComponent, Mt as popupTransitionStateMapping, Ot as Timeout, P as useFloatingPortalNode, Pt as triggerOpenStateMapping, T as useDismiss, a as applyPopupOpenChange, ct as addEventListener, d as usePopupInteractionProps, f as usePopupRootStore, g as useOpenChangeComplete, i as PopupHandleAttachment, jt as popupStateMapping, kt as useTimeout, l as useImplicitActiveTrigger, m as useTriggerDataForwarding, n as PopupTriggerMap, ot as useValueAsRef, r as FOCUSABLE_POPUP_PROPS, u as useOpenStateTransitions, w as fastComponentRef, x as ReactStore, yt as isMouseLikePointerType, z as POPUP_COLLISION_AVOIDANCE } from "./inertValue-DNbsVbsV.js";
import { t as useBaseUiId } from "./useBaseUiId-BM8ExPIN.js";
import { a as useHoverFloatingInteraction, c as getDelay, i as useHoverReferenceInteraction, n as usePopupViewport, o as useHoverInteractionSharedState, r as safePolygon, s as useFocus, t as popupViewportStateMapping } from "./usePopupViewport-Bj3zWyrr.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { n as usePositioner, o as getDisabledMountTransitionStyles, r as useAnchorPositioning } from "./usePreviousValue-BmpqdMgy.js";
import { t as require_react_dom } from "./react-dom.js";
import { a as popupStoreSelectors, i as createPopupFloatingRootContext, n as usePopupHandleStore, o as BasePopupHandle, r as createInitialPopupStoreState, t as NullStore } from "./NullStore-GURpCK0n.js";
